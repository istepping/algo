...
class TimeGCN(nn.Module):
    def __init__(self, in_features=3, out_features=4):
        ...
        self.gcn1 = GraphConvolution(in_features, 15)
        self.gcn2 = GraphConvolution(15, 30)
        self.gcn3 = GraphConvolution(30, 15)
        self.fc = nn.Linear(in_features=15, out_features=out_features)
